...
extern uint32_t ram[RAMNUM][8];
extern int32_t ramfill[RAMNUM][8];
extern int32_t ramnumber[8];
extern int32_t reg[REGNUM][8];
extern uint32_t freg[REGNUM][8];
extern Pc pc[8];
//extern int pc;
extern uint64_t count[256];
extern int cdr[8];
extern uint64_t ir[8];
extern uint32_t ir32[8];
extern int32_t lr[8];
extern int32_t end[8];
extern uint64_t cnt[8];
extern uint32_t limit[8];
